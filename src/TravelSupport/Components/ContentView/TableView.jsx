      ...
      <table className="w-full text-sm text-left">
        <thead>
          <tr className="bg-gray-50 border-b border-gray-100">
            ...
            <th className="px-5 py-3.5 text-xs font-semibold text-gray-500 uppercase tracking-wider text-center">Icon Class</th>
            ...
            return (
              <tr key={id} className="hover:bg-blue-50/30 transition-colors">
                ...
                <td className="px-5 py-4 text-center">
                  <span className="font-mono text-xs bg-sky-50 text-sky-600 px-2 py-0.5 rounded-lg">{item.item_icon || "—"}</span>
                </td>
